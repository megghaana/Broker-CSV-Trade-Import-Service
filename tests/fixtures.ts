export const zerodhaCsv = `symbol,isin,trade_date,trade_type,quantity,price,trade_id,order_id,exchange,segment
...
export const ibkrCsv = `TradeID,AccountID,Symbol,DateTime,Buy/Sell,Quantity,TradePrice,Currency,Commission,NetAmount,AssetClass
